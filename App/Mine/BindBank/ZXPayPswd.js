...
class PayPswd extends Component {
            ...
            <ScrollView
                ...
                <View style = {[styles.scoreStyle,{marginTop:10}]} >
                    <View style = {{justifyContent:'center',marginLeft:5}}>
                        <Text style = {{fontSize:10}}>提款密码</Text>
                    </View>
	                <TextInput
                ...
                <View style = {[styles.scoreStyle]} >
                    <View style = {{justifyContent:'center',marginLeft:5}}>
                        <Text style = {{fontSize:10}}>确认密码</Text>
                    </View>
		            <TextInput
		                style={styles.textInputStyle}
		                placeholder = '请再次输入密码'
                ...
                <Text style = {{marginLeft:5,fontSize:8,marginTop:5}}>提款密码由6-16位数字和字母组成</Text>
                <TouchableOpacity
                    activeOpacity={1.0}
